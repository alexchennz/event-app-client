      ...
      <div className="absolute bottom-0 top-0 left-0 right-0 bg-gray-900 rounded-t-3xl p-6 space-y-6">
        ...
        <div>
          ...
          {openSection.date && (
            <div className="flex gap-3">
              <button className="bg-purple-600 text-white px-4 py-2 rounded-full text-sm">Today</button>
              <button className="bg-gray-800 text-gray-300 px-4 py-2 rounded-full text-sm">Tomorrow</button>
              <button className="bg-gray-800 text-gray-300 px-4 py-2 rounded-full text-sm">This Weekend</button>
            </div>
          )}
        </div>
        ...
        <div>
          ...
          {openSection.location && (
            <div className="flex gap-3">
              <button className="bg-purple-600 text-white px-4 py-2 rounded-full text-sm">Auckland</button>
              <button className="bg-gray-800 text-gray-300 px-4 py-2 rounded-full text-sm">Wellington</button>
              <button className="bg-gray-800 text-gray-300 px-4 py-2 rounded-full text-sm">Christchurch</button>
            </div>
          )}
        </div>
        ...
        <div>
          ...
          {openSection.category && (
            <div className="grid grid-cols-2 gap-3">
              <button className="bg-purple-600 text-white px-4 py-2 rounded-xl text-sm flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                  <path strokeLinecap="round" strokeLinejoin="round" d="m9 9 10.5-3m0 6.553v3.75a2.25 2.25 0 0 1-1.632 2.163l-1.32.377a1.803 1.803 0 1 1-.99-3.467l2.31-.66a2.25 2.25 0 0 0 1.632-2.163Zm0 0V2.25L9 5.25v10.303m0 0v3.75a2.25 2.25 0 0 1-1.632 2.163l-1.32.377a1.803 1.803 0 0 1-.99-3.467l2.31-.66A2.25 2.25 0 0 0 9 15.553Z" />
                </svg>
                Music
              </button>
              <button className="bg-gray-800 text-gray-300 px-4 py-2 rounded-xl text-sm flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
